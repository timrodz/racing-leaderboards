defmodule RacingLeaderboardsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RacingLeaderboardsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RacingLeaderboardsWeb.Gettext, "errors", msg, opts)
    end
  end
